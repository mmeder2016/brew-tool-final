...
export default className Fermentables extends React.Component {
        ...
        return (
            <div id={fid} className="form-group">
                ...
                <div className="col-lg-2 col-lg-offset-1 col-md-2 col-md-offset-1 col-sm-2 col-sm-offset-0 col-xs-3 col-xs-offset-2">
                    <input id={ozsid} className="form-control input-margins" type="text" value="16">
                </div>
                ...
                <div className="col-lg-3 col-md-4 col-sm-4">
                    <input id={fmntid} className="form-control input-margins" type="text" value="Pilsner Malt (DE)">
                </div>
